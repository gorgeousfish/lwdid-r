...
#'   \code{"cluster"}, \code{"bootstrap"}. Case-insensitive (e.g.
#'   \code{"HC3"} is accepted). Aliases: \code{"wcb"} and
#'   \code{"wild_cluster_bootstrap"} map to \code{"bootstrap"};
#'   \code{"homoskedastic"} maps to \code{NULL}. Supported for
