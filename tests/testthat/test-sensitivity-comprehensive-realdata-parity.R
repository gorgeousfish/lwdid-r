...
resolve_parity_oracle_path <- function(filename) {
  resolve_parity_fixture_path(filename)
}

test_that("E8-03 smoking parity oracle matches current comprehensive sensitivity output", {
  skip_if_not_installed("jsonlite")

  oracle_path <- resolve_parity_oracle_path(
